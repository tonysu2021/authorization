...
CREATE  TABLE tb_basic_table ( 
  description varchar(256) DEFAULT NULL,
  created timestamptz  NOT NULL,
  updated timestamptz  NOT NULL
);

COMMENT ON TABLE tb_basic_table IS '基本表';
COMMENT ON COLUMN tb_basic_table.description IS '備註';
...
CREATE TABLE tb_permission (
  ...
  LIKE tb_basic_table INCLUDING ALL ,
  CONSTRAINT pk_tb_permission_id PRIMARY KEY ( id )
);
...
CREATE TABLE tb_role_permission (
  ...
  LIKE tb_basic_table INCLUDING ALL ,
  CONSTRAINT pk_tb_role_permission_id PRIMARY KEY ( id )
);
...
(uuid_generate_v4(),'role01','per37',NULL,NOW(),NOW()),
(uuid_generate_v4(),'role01','per38',NULL,NOW(),NOW()),
(uuid_generate_v4(),'role01','per39',NULL,NOW(),NOW()),
(uuid_generate_v4(),'role01','per40',NULL,NOW(),NOW()),
(uuid_generate_v4(),'role01','per41',NULL,NOW(),NOW()),
(uuid_generate_v4(),'role01','per42',NULL,NOW(),NOW()),
(uuid_generate_v4(),'role01','per43',NULL,NOW(),NOW()),
(uuid_generate_v4(),'role01','per44',NULL,NOW(),NOW()),
(uuid_generate_v4(),'role01','per45',NULL,NOW(),NOW());
...
CREATE TABLE tb_user_role (
  ...
  role_id character varying(64) NOT NULL,
  LIKE tb_basic_table INCLUDING ALL ,
  CONSTRAINT pk_tb_user_role_id PRIMARY KEY ( id )
);
...
(uuid_generate_v4(),'admin','role01',NULL,NOW(),NOW()),
(uuid_generate_v4(),'user01','role01',NULL,NOW(),NOW());